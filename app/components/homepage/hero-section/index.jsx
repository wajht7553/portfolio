 ...
 * It includes a background image, a greeting message with the user's name and designation,
 * social media links, and buttons for contacting and downloading the resume.
 *
 * @component
 * @example
 * return (
          ...
          <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
            <code className="font-mono text-xs md:text-sm lg:text-base">
              ...
              <div>
                ...
                <span className="text-gray-400">{`'`}</span>
                <span className="text-amber-300">Wajahat Ullah</span>
                <span className="text-gray-400">{`',`}</span>
              </div>
              ...
              <div>
                ...
                <span className="ml-2 lg:ml-4 mr-2 text-cyan-400">self</span>
              ...
              <div>
                ...
                <span className="text-white">&apos;hard_worker&apos;</span>
              ...
              <div>
                <span className="ml-12 lg:ml-24 text-orange-400">len</span>
                <span className="text-gray-400">{`(`}</span>
